    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/meerotheo/justdrinkwater/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/meerotheo/justdrinkwater.git")
                    developerConnection.set("scm:git:ssh://github.com/meerotheo/justdrinkwater.git")
                    url.set("https://github.com/meerotheo/justdrinkwater/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/meerotheo/justdrinkwater/issues")
                }
            }
        }
    }
